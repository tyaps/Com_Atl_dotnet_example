========================================================================
    ACTIVE TEMPLATE LIBRARY : ATLProject2 Project Overview
========================================================================

AppWizard has created this ATLProject2 project for you to use as the starting point for
...
ATLProject2.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (ATLProject2.h)
        GUID definitions                                (ATLProject2_i.c)
        A type library                                  (ATLProject2.tlb)
        Marshaling code                                 (ATLProject2_p.c and dlldata.c)

ATLProject2.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in ATLProject2.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named ATLProject2.pch and a precompiled types file named StdAfx.obj.
...
ATLProject2ps.vcxproj
	...
	dlldata.c, ATLProject2_i.c and ATLProject2_p.c which are required
	to build the proxy/stub DLL.

ATLProject2ps.vcxproj.filters
